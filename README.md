...
Auxiliary document ([appendices.pdf](https://github.com/cduan2020/EigenOPF/blob/master/appendices.pdf)) contains the detailed power system model and the derivation of the linearized system (Appendix A) as well as the derivation of the analytical gradients of Jacobian eigenvalues (Appendix B). 
