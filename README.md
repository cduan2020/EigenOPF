...
The detailed power system model and the techiques to derive the linearized system and the associated derivative information are presented in [appendices.](https://github.com/cduan2020/EigenOPF/blob/master/appendices.pdf)
